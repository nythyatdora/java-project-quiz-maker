...
public class DialogAddCollection extends javax.swing.JDialog {
    
    private DialogBrowseCollection dialogBrowseCollection;
    
    public DialogAddCollection ( java.awt.Frame parent, boolean modal ) {
        super (parent, modal);
        initComponents ();
    }

    public DialogAddCollection(java.awt.Frame parent, boolean modal, DialogBrowseCollection dialogBrowseCollection) {
        super (parent, modal);
        initComponents ();
    ...
    private void initComponents() {
        ...
        label_title.setText("CREATE A COLLECTION");
    ...
    private void button_createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_createActionPerformed
        if( VerifyVariable.hasDialogOpened (dialogBrowseCollection)) {
            dialogBrowseCollection.setAddingCollectionName (text_input.getText ());
            dialogBrowseCollection.addCollection ();
            dialogBrowseCollection.setDialogAddCollectionClosed ();
        }
        this.dispose ();
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        if( VerifyVariable.hasDialogOpened (dialogBrowseCollection) ) {
            dialogBrowseCollection.setAddingCollectionName ("");
            dialogBrowseCollection.setDialogAddCollectionClosed ();
        }
    ...
    public static void main ( String args[] ) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger (DialogAddCollection.class.getName ()).log (java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater (new Runnable () {
            public void run () {
                DialogAddCollection dialog = new DialogAddCollection (new javax.swing.JFrame (), true);
